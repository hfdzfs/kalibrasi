        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav navigasi ml-auto">
            <li class="nav-item active">
              <a class="nav-link" href="index.html" style="box-sizing: border-box; background-color: maroon;">Home <span class="sr-only">(current)</span></a>
            </li>
            ...
            <li class="nav-item active">
              <a class="nav-link" href="./news&event.html">News & Event</a>
            </li>
            <li class="nav-item active">
